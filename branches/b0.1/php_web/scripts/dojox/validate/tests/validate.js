	...
	[{
		...
		setUp: function(){
			...
			for(var i = 0 ; i < localeList.length; i ++){
				dojo.requireLocalization("dojo.cldr", "currency", localeList[i], "pt,zh,ROOT,zh-tw,ko,it,en-au,fr,en-us,en-ca,ja,en,de,es");
				dojo.requireLocalization("dojo.cldr", "number", localeList[i], "pt,zh,zh-tw,ko,it,en-au,ROOT,fr,en-us,ja,en,en-gb,ja-jp,es-es,de,zh-cn,ko-kr,de-de,es");
			}
		},
