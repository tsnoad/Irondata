...
class ParserXHTML extends Parser {
  function &process($html, &$pipeline, &$media) {
    ...
    $dom_tree = TreeBuilder::build($html); /* $html, i.e. first argument to parser->process() is not meant to be an empty string, but is for report 551 (string passed as user input) */
