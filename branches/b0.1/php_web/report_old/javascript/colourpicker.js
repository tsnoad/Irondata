...
//---------------------------------------------------------
     ...
     function setDiv() {     
        ...
        elemDiv.innerHTML = '<span style="font-family:Verdana; font-size:11px;">Pick a color: ' 
        	...
        	+ getColorTable() 
        	+ '<center>Color picker by <a href="http://www.flooble.com" target="_blank"><b>flooble</b></a></center></span>';
